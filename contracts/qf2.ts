...
/*
function getProjectContributions(proposalID: number): Contribution[] {
...
/*
function addProjectContribution(proposalID: number, contribution: Contribution): void {
    const existingContributions = getProjectContributions(proposalID);
